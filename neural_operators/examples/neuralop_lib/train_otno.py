"""
In this example I fix all the hyperparameters for the OTNO model and train it.
"""
...
def train_otno(which_example: str, loss_fn_str: str):
    ...
    model_builder = lambda config: OTNO(
    ...
    experiment_name = f"OTNO/{which_example}/loss_{loss_fn_str}_mode_testing"
