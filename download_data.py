...
def extract_folder_id(folder_url):
    ...
    if "folders/" in folder_url:
        ...
        raise ValueError("Invalid folder URL. Ensure it includes 'folders/<FOLDER_ID>'.")
...
def main():
    parser = argparse.ArgumentParser(description="Google Drive Folder Downloader/Uploader")
