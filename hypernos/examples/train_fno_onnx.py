...
from hypernos.architectures import FNO_ONNX
...
def train_fno_onnx(which_example: str, mode_hyperparams: str, loss_fn_str: str):
    ...
    model_builder = lambda config: FNO_ONNX(
        config["problem_dim"],
        config["in_dim"],
        config["width"],
        config["out_dim"],
...
if __name__ == "__main__":
    train_fno_onnx("afieti_fno", "default", "L2")
