"""
In this example I fix all the hyperparameters for the IgaNet Transformer model
and train it on the multi-patch AFIETI Schur-complement dataset (mp_afieti /
YetiSchurTransformer, reading data/mp_afieti/yeti_dataset.csv).
"""
