...
from hypernos.architectures import FNO, compute_modes, count_params_fno
...
def train_samedof_fno(which_example: str, loss_fn_str: str, maximum: int):
    ...
    hyperparams_train, hyperparams_arc = initialize_hyperparameters(
        "FNO", which_example, "best_samedofs"
    )
...
if __name__ == "__main__":
    train_samedof_fno("poisson", "L2", 33)
